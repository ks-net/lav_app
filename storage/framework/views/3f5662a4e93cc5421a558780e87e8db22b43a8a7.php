            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="<?php echo e(route('adminsettings')); ?>"><i class="fa fa-cogs"></i> Default Settings</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="<?php echo e(route('adminpostlist')); ?>"><i class="fa fa-file-text"></i> List All Posts</a>
                        <a class="dropdown-item" href="<?php echo e(route('adminpostcreate')); ?>"><i class="fa fa-plus-square"></i> Add new Post</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="<?php echo e(route('adminmedialist')); ?>"><i class="fa fa-image"></i> List All Media</a>
                        <a class="dropdown-item" href="<?php echo e(route('adminmediaadd')); ?>"><i class="fa fa-plus-square"></i> Add New Media</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
