        ...
        <div class="col-md-12 col-md-offset-0">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="well-sm">
                 <a href="{{url('media/add')}}" class="btn btn-success"> Add New Media <i class="fas fa-plus-circle"></i></a>
                 <a href="{{url('media/')}}" class="btn btn-default"> Media Index Page <i class="fas fa-share"></i></a>
                 <a href="{{url('post/list')}}" class="btn btn-info"> posts Listing Page <i class="fas fa-list"></i></a>
                    </div>
                    @if (count($medias) === 0)
                ...
                <table class="table" style="background:#fff;">
                    ...
                    <tr>
                        ...
                        <td class="">
                            <a href="{{url($media->image)}}"  data-fancybox="group" data-caption="{{ $media->name }}"><img class="img-thumbnail" src="{{ $media->image_thumb }}" alt="{{ $media->name }}" title="{{ $media->name }}"/></a>
                        </td>

                        <td  class="hidden-xs" style="border-left:1px dashed #ddd;max-width:640px;">
                            <div class="small {{ $media->active === 1 ? '' : 'gray-out' }}">{{ str_limit($media->name , '120', '...') }}</div>
